...
function jsMinify() {
  return (
    src("src/js/**/*.js", { sourcemaps: true }) //path includeing all js files in all folders
...
function sassMinify() {
  return (
    src(["src/sass/**/*.scss", "src/css/**/*.css"], { sourcemaps: true })
...
function watchTask() {
  ...
  watch(
    ["src/js/**/*.js", "src/css/**/*.css", "src/sass/**/*.scss"],
    { interval: 1000 },
